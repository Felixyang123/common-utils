...
public class RedisSlidingWindowRateLimiter extends RedisRateLimiter {
    ...
    public RedisSlidingWindowRateLimiter(RedisTemplate<String, String> redisTemplate, int maxRequests, int windowSize) {
        super(redisTemplate, "classpath:redis/sliding_window.lua", -1, maxRequests);
