...
class ThreadPoolConfigServiceTest {
    ...
    private ThreadPoolConfigService service;

    @BeforeEach
    void setUp() {
        service = new ThreadPoolConfigService(configRep, configAppRep, configConverter, logService);
    }
